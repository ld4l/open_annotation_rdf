...
describe 'LD4L::OpenAnnotationRDF::TagAnnotation' do
  ...
  describe 'rdf_subject' do
    ...
    it "should append to base URI when setting to non-URI subject" do
      ...
      expect(subject.rdf_subject).to eq RDF::URI("#{LD4L::OpenAnnotationRDF::TagAnnotation.base_uri}#{LD4L::OpenAnnotationRDF::TagAnnotation.id_prefix}123")
    end
  ...
  describe '#rdf_label' do
    ...
    it 'should return the default label as URI when no title property exists' do
      expect(subject.rdf_label).to eq [RDF::URI("#{LD4L::OpenAnnotationRDF::TagAnnotation.base_uri}#{LD4L::OpenAnnotationRDF::TagAnnotation.id_prefix}123")]
    end
