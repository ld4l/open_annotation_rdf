...
module LD4L
  module OpenAnnotationRDF
    class Annotation < LD4L::OpenAnnotationRDF::ResourceExtension
      ...
      property :annotatedBy, :predicate => RDFVocabularies::OA.annotatedBy, :class_name => LD4L::OpenAnnotationRDF::Person
